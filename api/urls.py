...
urlpatterns = [
    ...
    path('dashboard/posts/<int:user_id>/<int:post_id>/delete/', api_views.DashboardPostDeleteAPIView.as_view(), name='dashboard-post-delete'),
    path('post/search/', api_views.search_posts, name='search_posts'),
